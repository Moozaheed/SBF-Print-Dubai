...
export const metadata: Metadata = {
  ...
  description: "SBF Print & Design — commercial printing press at Nakheel Centre, Deira Dubai. Business cards, 3D signage, LED neon, banners, stickers & custom packaging. Same-day printing & delivery across Dubai & UAE. Call +971 052 506 9091.",
  alternates: {
    canonical: "https://sbfprint.ae",
  },
  openGraph: {
    title: "Printing Press Dubai | SBF Print & Design — Same Day Printing",
    description: "Nakheel Centre, Deira Dubai — commercial printing press for business cards, 3D signage, banners, stickers & custom packaging. Same-day printing & delivery. Free artwork check. Call +971 052 506 9091.",
